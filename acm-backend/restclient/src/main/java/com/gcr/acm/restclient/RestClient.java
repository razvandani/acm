...
public class RestClient {
     ...
     */
    @SuppressWarnings("unused")
    public <T> T post(String url, Object requestObject, JavaType responseJavaType, Map<String, String> requestHeaderMap) {
    ...
    private <T> T exchange(String url, HttpMethod httpMethod, Class<T> responseClass, HttpEntity<Object> httpEntity,
                           Object... uriVariables) {
        return exchangeInternal(url, httpMethod, responseClass, httpEntity, uriVariables);
    }

    private <T> T exchange(String url, HttpMethod httpMethod, JavaType responseType,
                           HttpEntity<Object> httpEntity, Object... uriVariables) {
        return exchangeInternal(url, httpMethod, responseType, httpEntity, uriVariables);
    }

    private <T> T exchangeInternal(String url, HttpMethod httpMethod, Object responseType,
                           HttpEntity<Object> httpEntity, Object... uriVariables) {
        try {
            ResponseEntity<String> response = restTemplate.exchange(url, httpMethod, httpEntity, String.class, uriVariables);
     ...
     */
    @SuppressWarnings("unused")
    public <T> T put(String url, Object requestObject, JavaType responseJavaType, Map<String, String> requestHeaderMap) {
        HttpEntity<Object> httpEntity = getHttpEntity(requestObject, requestHeaderMap);
     ...
     */
    @SuppressWarnings("unused")
    public <T> T delete(String url, Class<T> responseClass) throws RestException {
     ...
     */
    @SuppressWarnings("unused")
    public <T> T delete(String url, JavaType responseJavaType, Map<String, String> requestHeaderMap) {
     ...
     * @return The response object
     */
    public <T> T delete(String url,Class<T> responseClass, Map<String, String> requestHeaderMap) throws RestException {
        HttpEntity<Object> httpEntity = getHttpEntity(null, requestHeaderMap);
    ...
    private HttpEntity<Object> getHttpEntity(Object requestObject, Map<String, String> requestHeaderMap) {
        ...
        if (requestHeaderMap == null || !requestHeaderMap.containsKey("Accept-Language")) {
            try {
     ...
     * @return The response object
     */
    public <T> T get(String url, JavaType responseJavaType, Map<String, String> requestHeaderMap, Object... requestParameters) {
        HttpEntity<Object> httpEntity = getHttpEntity(null, requestHeaderMap);
